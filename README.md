Данный программный продукт предназначен для автоматизации взаимодействия жильцов с персоналом товарищества собственников посредством мессенджера «Telegram».
ФУНКЦИИ СИСТЕМЫ
